...
import { BelgradeJVMChain, Blockchain, BelgradeRelayChain } from "../dist/chain"
...
async function main () {
    ...
    const assetId: string = BelgradeJVMChain.assetId
    ...
    const destinationChain: Blockchain = BelgradeRelayChain
