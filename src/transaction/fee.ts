...
export class FeeManager {
    ...
    static async calculate (provider: MCNProvider, source: Blockchain, destination: Blockchain): Promise<bigint> {
        ...
        if (source.id === destination.id) {
            return sourceAdapter.queryBaseFee(provider)
        }
