...
export const SocotraJUNEChain: JEVMBlockchain = new JEVMBlockchain(
  'JUNE-Chain', '2sKLzfKH6G6pJspijPAJECFekJLCi9h1P5WHEUFZgcUVBf82Mp', SocotraJUNEAssetId, BigInt(220001), SocotraAddress, ['JUNE'], [
    new JRC20Asset('0x2d00000000000000000000000000000000000000', 'Ethereum', 'ETH.e', 9, 'JeUvxJPXoL3EtVGSPwtyYXVymxGbpcBcaa2Kq7TCB43HsKMAS'),
    new JRC20Asset('0x2e00000000000000000000000000000000000000', 'mBitcoin', 'mBTC.a', 9, '2pLiXK8pUNqS9DHTKpkiex6g6DRdSfxqJCoZsLM3zq62WtFje3'),
    new JRC20Asset('0x2f00000000000000000000000000000000000000', 'Doge', 'DOGE.b', 9, '2PR1Dn3w6QUcvVAsb2UTw7F6khcVBjC68SLgyW6MdoqtpaE7ox'),
    new JRC20Asset('0x3000000000000000000000000000000000000000', 'TrueUSD', 'TUSD.e', 9, 'saRTCAtLBo4d3WvJT3ibJmv9dpn3oQQ8gXgkB8ADsQwiFJh6L'),
    new JRC20Asset('0x3100000000000000000000000000000000000000', 'Tether USD', 'USDT.e', 9, '2TBXB5U2rqPWqebfvjvXJNu27vig6s5mCgkdLYBJzE6jXnrNso'),
    new JRC20Asset('0x3200000000000000000000000000000000000000', 'Dai', 'DAI.e', 9, '2vq3K3PxumUV7Uf9PgPoBfr1y8MDjAtMDRex8yTqYzfyrtVJJU'),
    new JRC20Asset('0x3300000000000000000000000000000000000000', 'Euro Coin', 'EUROC.e', 9, '2NQFaeBwMcACKqsKqMoLzYmVAHMYeFREfYJq6dtQnsJ5tTyk42'),
    new JRC20Asset('0x3400000000000000000000000000000000000000', 'Litecoin', 'LTC.b', 9, '2REm6DRSgbVyE4dypnzBU9WWUV4zW9VcsTMHiDha7GLV84ZXCy'),
    new JRC20Asset('0x3500000000000000000000000000000000000000', 'Stellar', 'XLM.x', 9, '25revVW7o2DgkhQPTkbGLNxscS6G9Mj6eTu7PCgKvzw3HM7pJv'),
    new JRC20Asset('0x3600000000000000000000000000000000000000', 'Bitcoin Cash', 'BCH.b', 9, '2sC7LPyJguMWdJztKGUa35ABj7KRh1WSNQThLWhdxhJJwGdhv2'),
    new JRC20Asset('0x3700000000000000000000000000000000000000', 'Pax Gold', 'PAXG.e', 9, 'VKJNVVGFPWwrpbYtdGanMhTdScZrRYWbgE1JVqzj2YGnU8ewv'),
    new JRC20Asset('0x3800000000000000000000000000000000000000', 'Internet Computer', 'ICP.x', 9, 'HiNZ8RV33htiXovM2P66DZADWyHuRyEwcyRYJcB8ivNMvsqP1'),
    new JRC20Asset('0x3900000000000000000000000000000000000000', 'XIDR', 'XIDR.e', 9, 'bvyN7nY8NFpQc7BGQEfFRaBu9Wqj53NpDb9GZ2raAxsuN9GP5'),
    new JRC20Asset('0x3a00000000000000000000000000000000000000', 'XSGD', 'XSGD.e', 9, '2BvFezbxtuztCGJbGvz8Dx7woKqMLeZNZ6C6assFMFwGVcCpaH'),
    new JRC20Asset('0x3b00000000000000000000000000000000000000', 'Ethereum Classic', 'ETC.x', 9, '3sPY2qNyaGop5JNLaSr8GtWHrimtMMkYifACSRVZNKEyZowBg'),
    new JRC20Asset('0x3c00000000000000000000000000000000000000', 'R1000', 'R1000.a', 9, 'G3mH67ubqNAJB6txHTHFtFzH56ynrhd2ynJrUk6RjT9iBzXbK'),
    new JRC20Asset('0x3d00000000000000000000000000000000000000', 'R10', 'R10.a', 9, 'tDxKdhyn2b9dNLMdsSv3xEY8ihGf7991XSWxXMzWu1bLtAued')
  ]
)
...
export const BelgradeJUNEChain: JEVMBlockchain = new JEVMBlockchain('JUNE-Chain', '21Fsdh9v1PGLey87GVLnkH89icNzLWrgn3CH1vL6Tb7J7hu5w5',
  BelgradeJUNEAssetId, BigInt(330001), BelgradeAddress, ['JUNE'], [
    new JRC20Asset('0x2d00000000000000000000000000000000000000', 'USD Coin', 'USDC.e', 9, 'f2aFbTdjMLPeLTbi8EzqjJwx95zF9jhdG4zQ6JWRgTAmihCZv'),
    new JRC20Asset('0x2e00000000000000000000000000000000000000', 'BUSD', 'BUSD.b', 9, '2h4isjyZaNpKf5qFt5gBfAZGXcWRVgUqVaNYE9LRFNrF4rqKwx'),
    new JRC20Asset('0x2f00000000000000000000000000000000000000', 'Euro Coin', 'EUROC.e', 9, '2dBT199DhU99qgohAbG1oYM9PuGoAy6xPpBJ4EUDhPpCKyF7n3'),
    new JRC20Asset('0x3000000000000000000000000000000000000000', 'Pax Gold', 'PAXG.e', 9, 'XP39Jfa56x33U269ejiKgP6XZ5GXkMZX5m7ZR63u3gDSZVShs'),
    new JRC20Asset('0x3100000000000000000000000000000000000000', 'mBitcoin', 'mBTC.a', 9, 'tFA26E4syGj9KEyA3hZemp7qMaQ6KqBB4h4M4Y9xRmxQ18zuX')
  ]
)
