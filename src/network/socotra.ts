...
const SocotraRewardConfig = new RewardConfig(
  ...
  BigInt(2_0000), // 2%
  BigInt(1711929600), // 1st April 2024
  BigInt(21_5000), // 21.5%
  BigInt(1869696000), // 1st April 2029
  BigInt(19_5000), // 19.5%
  BigInt(1901232000), // 1st April 2030
  BigInt(6_7000) // 6.7%
)
...
const jrc20Assets: JRC20Asset[] = [
  ...
  new JRC20Asset('0x3300000000000000000000000000000000000000', 'Milli Bitcoin', 'mBTC', 9, SocotraMBTC1AssetId),
